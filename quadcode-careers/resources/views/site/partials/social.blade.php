@php
    $instagram = app(\A17\Twill\Repositories\SettingRepository::class)->byKey('instagram');
    $facebook = app(\A17\Twill\Repositories\SettingRepository::class)->byKey('facebook');
    $linkedin = app(\A17\Twill\Repositories\SettingRepository::class)->byKey('linkedin');
@endphp
@if ($instagram)
    <a class="app-footer__social-link" href="{{ $instagram }}">
...
@endif
@if ($facebook)
    <a href="{{ $facebook }}" class="app-footer__social-link">
...
@endif
@if ($linkedin)
    <a href="{{ $linkedin }}" class="app-footer__social-link">
